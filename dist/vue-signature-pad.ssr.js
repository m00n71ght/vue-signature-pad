...
var TRANSPARENT_PNG = {
  ...
  methods: {
    ...
    fromBlobToDataUrl: function fromBlobToDataUrl(type, encoderOptions) {
      var canvas = this.$refs.signaturePadCanvas;
    ...
    saveSignature: function saveSignature() {
      ...
      return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var type, encoderOptions, signaturePad, status, imageTypesString;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                type = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : IMAGE_TYPES[0];
                encoderOptions = _arguments.length > 1 ? _arguments[1] : undefined;
                signaturePad = _this2.signaturePad;
                status = {
                  isEmpty: false,
                  data: undefined
                };
                ...
                imageTypesString = IMAGE_TYPES.join(', ');
              ...
              case 7:
                ...
                return _context.abrupt("return", _objectSpread2(_objectSpread2({}, status), {}, {
                  isEmpty: true
                }));

              case 11:
                _context.next = 13;
                return _this2.fromBlobToDataUrl(type, encoderOptions);

              case 13:
                _this2.signatureData = _context.sent;
                return _context.abrupt("return", _objectSpread2(_objectSpread2({}, status), {}, {
                  data: _this2.signatureData
                }));
